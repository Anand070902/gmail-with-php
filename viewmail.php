                   ...
                   <?php if($row['status'] == -1):?>
                    ...
                    <?php endif; ?>
                       ...
                       if($row['attachement'] != null): ?>
                         ...
                         <img src="attachement/<?= $row['attachement'];?>" class="w-25" alt="">
                         <a href="attachement/<?= $row['attachement'];?>" class="me-2">View</a>
                         <a href="attachement/<?= $row['attachement'];?>" download>Download</a>
